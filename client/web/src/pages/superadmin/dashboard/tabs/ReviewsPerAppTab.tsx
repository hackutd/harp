...
export function ReviewsPerAppTab({
  reviewsPerApp,
  setReviewsPerApp,
  loading,
      ...
      <Card className="bg-zinc-900 border-zinc-800 border-0 rounded-md">
        <CardHeader>
          ...
          <CardDescription className="text-zinc-400">
            How many admin reviews each application needs before a decision can
            be made. Changes only affect future assignments.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-center gap-3">
            ...
            <span className="w-8 text-center text-md font-light text-zinc-100">
              {reviewsPerApp}
            </span>
            <Button
              variant="outline"
