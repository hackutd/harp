  ...
  return (
    <div className="mx-auto max-w-2xl px-5 pt-4 pb-8 md:max-w-5xl md:px-8">
      ...
      {travelRSVP.travel_rsvp_status !== "pending" ? (
        <TravelRSVPResult status={travelRSVP.travel_rsvp_status} />
        ...
        <>
          ...
          <p className="mt-2 text-sm font-light text-[#8A8A8A]">
            ...
            getting here, upload proof of travel, and let us know how you&apos;d
            like to be paid. You can only submit once.
          </p>
