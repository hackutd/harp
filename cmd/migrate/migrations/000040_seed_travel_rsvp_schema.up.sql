...
INSERT INTO settings (key, value) VALUES ('travel_rsvp_schema', '[
    ...
    {"id": "travel_cost_total", "type": "number",   "label": "Total travel cost (USD)",         "required": true,  "section": "travel_rsvp", "section_label": "Travel Details", "section_order": 1, "display_order": 4, "validation": {"min": 0}},
    {"id": "payment_method",    "type": "select",   "label": "How would you like to be paid?",  "required": true,  "section": "travel_rsvp", "section_label": "Travel Details", "section_order": 1, "display_order": 5, "options": ["Zelle", "Venmo", "PayPal", "Check"]},
    {"id": "payment_details",   "type": "text",     "label": "Payment handle / details (Zelle email, Venmo username, or mailing address for check)", "required": true, "section": "travel_rsvp", "section_label": "Travel Details", "section_order": 1, "display_order": 6},
    {"id": "travel_notes",      "type": "textarea", "label": "Anything else we should know?",   "required": false, "section": "travel_rsvp", "section_label": "Travel Details", "section_order": 1, "display_order": 7, "validation": {"maxLength": 1000}}
]'::jsonb)
